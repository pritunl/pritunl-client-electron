...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(430);
    ...
    return (0,tslib__WEBPACK_IMPORTED_MODULE_0__/* .__generator */ .YH)(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, __webpack_require__.e(/* import() | blueprint-icons-16px-paths */ 672).then(__webpack_require__.bind(__webpack_require__, 2532))];
            case 1:
                pathsRecord = _a.sent();
                return [3 /*break*/, 4];
            case 2: return [4 /*yield*/, __webpack_require__.e(/* import() | blueprint-icons-20px-paths */ 783).then(__webpack_require__.bind(__webpack_require__, 2135))];
            case 3:
                pathsRecord = _a.sent();
                _a.label = 4;
