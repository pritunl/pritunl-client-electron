...
#define MyAppVersion "1.0.1356.36"
...
[Files]
Source: "..\build\win\pritunl-win32-ia32\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: PreInstall
